...
- COLLECTION : si un bloc « COLLECTION ÉQUIPE » est fourni, partage SON lien EN PRIORITÉ — une SEULE URL où le client voit TOUS les modèles de l'équipe d'un coup — au lieu de lister les produits un par un. Tu peux mentionner le prix « à partir de X dh » et inviter à cliquer. Ne liste les produits individuellement QUE s'il n'y a pas de collection pour cette équipe.
